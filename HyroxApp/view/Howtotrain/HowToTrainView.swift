...
struct HowToTrainView: View {
    ...
    let exercises: [Exercise] = [
        ...
        Exercise(title: "SkiErg", shortDescription: "Upper-body power and cardio", longDescription: "Use the SkiErg by driving strongly through the arms and core. Initiate with the legs and hip hinge, then finish with a powerful arm pull. Tempo control and full extension help develop sport-specific power and endurance for Hyrox.", videoURLString: "https://youtu.be/P7qpoJmX91I?si=hNYvB9prjpq0BG6l")
    ]
